          ...
          <ModalBody className="p-3">
            <div className="space-y-6">
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed m-0 mb-6">
                The Cyborg snippet lets manual testers record their actions
                directly on the website and convert them into automation code.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-sm m-0">
                      Click the Record button. The snippet will begin tracking
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-sm m-0 mb-2">
                      Navigate through the website just like a user. All actions
                      will be logged and displayed in the snippet as
                      ready-to-copy code.
                    </p>
                    <p className="text-slate-600 dark:text-slate-400 text-sm m-0">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-sm m-0">
                      Easily copy the generated code and paste it into your
